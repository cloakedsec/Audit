...
<html lang="en">
    <head>
        ...
        <meta
            name="title"
            content="Volt Bootstrap 5 Dashboard - Transactions"
        />
        ...
        <meta
            ...
            content="https://demo.themesberg.com/volt"
        />
        <meta
            ...
            <div class="sidebar-inner px-4 pt-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        >
                            <span class="sidebar-icon"
                                ><span class="fas fa-rocket mr-2"></span
                            ></span>
                    ...
                    >
                        ...
                        <ul class="navbar-nav align-items-center">
                            <li class="nav-item dropdown">
                                <a
                                    class="nav-link text-dark mr-lg-3 icon-notifications"
                                ...
                                >
                                    <div class="list-group list-group-flush">
                                        <a
                                            href="#"
                                            class="text-center text-primary font-weight-bold border-bottom border-light py-3"
                                            >Notifications</a
                                        >
                                        <a
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="font-weight-bold">$799,00</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="font-weight-bold">$533,42</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="font-weight-bold">$233,42</span>
                            </td>
                            <td>
                                <span class="font-weight-bold text-success"
                                    >Paid</span
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                        <p class="mb-0 text-center text-xl-left">
                            Copyright © 2019-<span class="current-year"></span>
                            <a
